...
public class Main {
    public static void main(String[] args) {
        ...
        Villa villaVechen = new Villa(villaJivot, 33);
        ...
        System.out.println("Get the hotelHemus accommodation by Id " +
                shitCompany.findAccommodationById("HOT-0").getLocation());
        System.out.println("Get the apartmentVazov accommodation by Id " +
                shitCompany.findAccommodationById("APA-0").getLocation());
        System.out.println("Get the villaJivot accommodation by Id " +
                shitCompany.findAccommodationById("VIL-0").getLocation());
...
//        System.out.println();
        ...
        shitCompany.findAccommodationById("VIL-0").book(
                LocalDateTime.of(2023, Month.MARCH, 25, 14, 0, 0),
        ...
        shitCompany.findAccommodationById("APA-0").book(
        ...
        //TEST CASE 1
        Criterion locCritHemus = new LocationCriterion(hotelHemus, 1000);
        ...
        System.out.println("The filteredBookables1 should be of length 1 and have just the Hemus hotel accommodation: Expected TRUE, TRUE --> " +
                ...
                (filteredBookables1[0].getId().equals("HOT-0") ? "TRUE" : "FALSE"));

        //TEST CASE 2
        Criterion priceCrit = new PriceCriterion(0, 50);
        ...
        System.out.println("The filteredBookables2 should be of length 1 and have just the Hemus hotel accommodation: Expected TRUE, TRUE --> " +
                ...
                (filteredBookables2[0].getId().equals("HOT-0") ? "TRUE" : "FALSE"));

        //TEST CASE 3
        Criterion locCritVazov = new LocationCriterion(apartmentVazov, 1000);
        ...
        //TEST CASE 4
        Criterion locCritJivot = new LocationCriterion(villaJivot, 1000);
        ...
        System.out.println("The filteredBookables4 should be of length 1 and have just the villa accommodation: Expected TRUE, TRUE --> " +
                ...
                (filteredBookables4[0].getId().equals("VIL-0") ? "TRUE" : "FALSE"));
        ...
        System.out.println("The filteredBookables5 should be of length 1 and have just the apartment accommodation: Expected TRUE, TRUE --> " +
                ...
                (filteredBookables5[0].getId().equals("APA-0") ? "TRUE" : "FALSE"));
        ...
        System.out.println("The filteredBookables6 should be of length 2 and have the villa and hotel accommodations: Expected TRUE, TRUE, TRUE --> " +
                ...
                (filteredBookables6[0].getId().equals("HOT-0") ? "TRUE" : "FALSE")  + ", " +
                (filteredBookables6[1].getId().equals("VIL-0") ? "TRUE" : "FALSE"));
        ...
        System.out.println("The filteredBookables7 should be of length 3 and have all the accommodations: Expected TRUE, TRUE, TRUE, TRUE --> " +
                ...
                (filteredBookables7[0].getId().equals("HOT-0") ? "TRUE" : "FALSE")  + ", " +
                (filteredBookables7[1].getId().equals("APA-0") ? "TRUE" : "FALSE")  + ", " +
                (filteredBookables7[2].getId().equals("VIL-0") ? "TRUE" : "FALSE"));
