...
public class NewsFeedTest {
    ...
    private static String testApiKey = "a5c9b187c64340dcb1b9c768041ef20b";

    @BeforeAll
    static void initializeSingletonInstance() {
        newsFeed = NewsFeed.getInstance(testApiKey);
    }
    ...
    void testCreateHttpRequest() {
        ...
        var expectedUrl = newsFeed.getBaseUrl() +
    ...
    void testCreateHttpRequestDefaultValues() {
        ...
        var expectedUrl = newsFeed.getBaseUrl() + NewsFeed.QUERY_PARAMS_SEPERATOR + NewsFeed.QUERY_PAGESIZE + NewsRequest.BASE_PAGE_SIZE;
    ...
    @Test
    void testGetArticlesFromRequestThrowsIllegalArgumentExceptionBecauseOfInvalidPagesCount() throws URISyntaxException {
        var request = NewsRequest.builder()
            .addKeywords("heyyy")
            .build();
...
//    }
    ...
    void testGetArticlesFromRequestThrowsBadRequestException() throws URISyntaxException {
        ...
        var invalidUrl = NewsFeed.REQUEST_PROTOCOL + NewsFeed.REQUEST_HOST + NewsFeed.REQUEST_ENDPOINT +
            NewsFeed.QUERY_PARAMS_START + NewsFeed.QUERY_APIKEY + testApiKey + NewsFeed.QUERY_PARAMS_SEPERATOR;
    ...
    void testNewsFeedIsSingleton() {
        var newNewsFeed = NewsFeed.getInstance(testApiKey);
