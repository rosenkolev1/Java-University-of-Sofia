...
public class DailyFoodDiary implements FoodDiary {
    ...
    public DailyFoodDiary(NutritionInfoAPI nutritionInfoApi) {
        ...
        this.meals.put(Meal.BREAKFAST, new ArrayList<FoodEntry>());
        this.meals.put(Meal.LUNCH, new ArrayList<FoodEntry>());
        this.meals.put(Meal.SNACKS, new ArrayList<FoodEntry>());
        this.meals.put(Meal.DINNER, new ArrayList<FoodEntry>());
